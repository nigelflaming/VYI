...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("Vyigrat Core vyigrat-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  vyigrat-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded vyigrat transaction") + "\n" +
                               "  vyigrat-tx [options] -create [commands]   " + _("Create hex-encoded vyigrat transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded vyigrat transaction
