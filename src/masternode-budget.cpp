...
CAmount CBudgetManager::GetTotalBudget(int nHeight)
{
    ...
    //get block value and calculate from that
      ...
      if (nHeight > 200 && nHeight <= 14400)
          nSubsidy = 21 * COIN;
      else if (nHeight > 14400 && nHeight <= 28800)
          nSubsidy = 31.5 * COIN;
      else if (nHeight > 28800 && nHeight <= 72000)
          nSubsidy = 42 * COIN;
      else if (nHeight > 72000 && nHeight <= 144000)
          nSubsidy = 73.5 * COIN;
      else if (nHeight > 144000 && nHeight <= 288000)
          nSubsidy = 89.25 * COIN;
      else if (nHeight > 288000 && nHeight <= 576000)
          nSubsidy = 105 * COIN;
      else
          nSubsidy = 21 * COIN;
