...
public:
    ...
    void setZVyigratControlLabels(int64_t nAmount, int nQuantity);
...
//    void coinControlClipboardChange();
    ...
    void on_pushButtonMintzVYI_clicked();
    void on_pushButtonMintReset_clicked();
    void on_pushButtonSpentReset_clicked();
    void on_pushButtonSpendzVYI_clicked();
    void on_pushButtonZVyigratControl_clicked();
