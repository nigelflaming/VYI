                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("Vyigrat Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a Vyigrat address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and vyigrat: URIs)"));
    ...
    privacyAction->setStatusTip(tr("Privacy Actions for zVYI"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About Vyigrat Core"), this);
    aboutAction->setStatusTip(tr("Show information about Vyigrat Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for Vyigrat"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your Vyigrat addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified Vyigrat addresses"));
    ...
    openAction->setStatusTip(tr("Open a Vyigrat: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the Vyigrat Core help message to get a list with possible Vyigrat command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("Vyigrat Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to Vyigrat network", "", count));
}
...
{
    QString strTitle = tr("Vyigrat Core"); // default title
...
/** Creates context menu, its actions, and vyigrats up all the relevant signals for mouse events. */
