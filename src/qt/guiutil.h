...
/** Utility functions used by the Vyigrat Qt UI.
 */
namespace GUIUtil
{
...
// Render Vyigrat addresses in monospace font
...
// Parse "vyigrat:" URI into recipient object, return true on successful parsing
