...
Value stop(const Array& params, bool fHelp)
{
    ...
    StartShutdown();
    return "Vyigrat server stopping";
}
...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* Vyigrat features */
        {"vyigrat", "masternode", &masternode, true, true, false},
        {"vyigrat", "listmasternodes", &listmasternodes, true, true, false},
        {"vyigrat", "getmasternodecount", &getmasternodecount, true, true, false},
        {"vyigrat", "masternodeconnect", &masternodeconnect, true, true, false},
        {"vyigrat", "masternodecurrent", &masternodecurrent, true, true, false},
        {"vyigrat", "masternodedebug", &masternodedebug, true, true, false},
        {"vyigrat", "startmasternode", &startmasternode, true, true, false},
        {"vyigrat", "createmasternodekey", &createmasternodekey, true, true, false},
        {"vyigrat", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"vyigrat", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"vyigrat", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"vyigrat", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"vyigrat", "getmasternodescores", &getmasternodescores, true, true, false},
        {"vyigrat", "mnbudget", &mnbudget, true, true, false},
        {"vyigrat", "preparebudget", &preparebudget, true, true, false},
        {"vyigrat", "submitbudget", &submitbudget, true, true, false},
        {"vyigrat", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"vyigrat", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"vyigrat", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"vyigrat", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"vyigrat", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"vyigrat", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"vyigrat", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"vyigrat", "checkbudgets", &checkbudgets, true, true, false},
        {"vyigrat", "mnsync", &mnsync, true, true, false},
        {"vyigrat", "spork", &spork, true, true, false},
        {"vyigrat", "getpoolinfo", &getpoolinfo, true, true, false},
#ifdef ENABLE_WALLET
        {"vyigrat", "obfuscation", &obfuscation, false, false, true}, /* not threadSafe because of SendMoney */
...
void StartRPCThreads()
{
    ...
    if (((mapArgs["-rpcpassword"] == "") ||
        ...
        uiInterface.ThreadSafeMessageBox(strprintf(
                                             _("To use vyigratd, or the -server option to vyigrat-qt, you must set an rpcpassword in the configuration file:\n"
                                               "%s\n"
...
{
    return "> vyigrat-cli " + methodname + " " + args + "\n";
}
