...
In order to support loading of multiple wallets in vyigrat-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is vyigrat.cpp.
...
Changes to vyigrat.cpp
----------------------
vyigrat.cpp is the entry point into vyigrat-qt, and as such, will require some minor modifications to provide hooks for
