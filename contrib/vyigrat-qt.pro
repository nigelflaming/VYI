...
RESOURCES += src/qt/vyigrat.qrc src/qt/vyigrat_locale.qrc

TRANSLATIONS += src/qt/locale/vyigrat_bg.ts \
                src/qt/locale/vyigrat_de.ts \
                src/qt/locale/vyigrat_en.ts \
                src/qt/locale/vyigrat_es.ts \
                src/qt/locale/vyigrat_fi.ts \
                src/qt/locale/vyigrat_fr.ts \
                src/qt/locale/vyigrat_it.ts \
                src/qt/locale/vyigrat_ja.ts \
                src/qt/locale/vyigrat_pl.ts \
                src/qt/locale/vyigrat_pt.ts \
                src/qt/locale/vyigrat_ru.ts \
                src/qt/locale/vyigrat_sk.ts \
                src/qt/locale/vyigrat_sv.ts \
                src/qt/locale/vyigrat_vi.ts \
                src/qt/locale/vyigrat_zh_CN.ts \
                src/qt/locale/vyigrat_zh_TW.ts
