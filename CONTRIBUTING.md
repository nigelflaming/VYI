Contributing to Vyigrat Core
============================

The Vyigrat Core project operates an open contributor model where anyone is
...
The following applies to code changes to the Vyigrat Core project, and is not to be
confused with overall Vyigrat Network Protocol consensus changes.

Whether a pull request is merged into Vyigrat Core rests with the project merge
...
Patches that change Vyigrat consensus rules are considerably more involved than
...
Where a patch set proposes to change the Vyigrat consensus, it must have been
...
The project leader is the release manager for each Vyigrat Core release.
